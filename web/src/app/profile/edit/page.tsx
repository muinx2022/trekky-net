...
export default function EditProfilePage() {
  ...
  const { isLoggedIn, user, updateProfile, openLoginModal, logout, authorizedFetch } = useAuth();
  ...
  useEffect(() => {
    ...
    const loadProfile = async () => {
      setLoading(true);
      try {
        const res = await authorizedFetch("/api/profile-proxy", {
          cache: "no-store",
        });
  ...
  }, [isHydrated, isLoggedIn, user, openLoginModal, router, logout, authorizedFetch]);
